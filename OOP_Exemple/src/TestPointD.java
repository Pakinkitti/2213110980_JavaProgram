...
public class TestPointD {
	public void Main(String[] args) {
		...
		System.out.print("Default x, y of Point2D = "+p1);
		
		p1.setXY(10, 11);
		System.out.println("x,y of Point2D = "+p1.getXY());
		System.out.println("x of Point2D is : "+p1.getXY()[0]);
		System.out.println("y of Point2D is : "+p1.getXY()[1]);
		
		Point3D p2 = new Point3D();
		System.out.print("Default x, y and z of Point3D = "+p1);
		
		p2.setXYZ(10, 12,17);
		System.out.println("x,y and z of Point3D = "+p2.getXYZ());
